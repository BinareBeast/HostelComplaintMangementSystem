...
public class plumbinglog extends Fragment {
    RecyclerView recyclerView;
    SearchView searchView;
    FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
    DatabaseReference databaseReference = firebaseDatabase.getReference().child("4plumbing_complaints");
    Adapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_plumbinglog, container, false);
        recyclerView = v.findViewById(R.id.recy2);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        searchView = v.findViewById(R.id.psv);
